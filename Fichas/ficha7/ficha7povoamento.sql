...
CREATE TABLE IF NOT EXISTS `mydb`.`Cliente` (
  ...
  CONSTRAINT `fk_Cliente_Cliente`
    ...
    REFERENCES `mydb`.`Cliente` (`Numero`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- Table `mydb`.`Dourado`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Dourado` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`Clientetelefones` (
...
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`ClienteCupoes` (
...
CREATE TABLE IF NOT EXISTS `mydb`.`Venda_has_Produto` (
  ...
  CONSTRAINT `fk_Venda_has_Produto_Produto1`
    ...
    REFERENCES `mydb`.`Produto` (`Numero`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
